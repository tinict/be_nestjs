...
export * from './campaign_channel.bulk.schema';
export * from './campaign_channel.create.schema';
export * from './campaign_channel.update.schema';

//Campaign event schema
export * from './campaign_event.bulk.schema';
export * from './campaign_event.create.schema';
export * from './campaign_event.update.schema';

// Campaign ProposalPositionCondition schema
export * from './campaign_proposal_position_conditions.bulk.schema';
export * from './campaign_proposal_position_conditions.create.schema';
export * from './campaign_proposal_position_conditions.update.schema';

// Campaign schema
export * from './campaign.bulk.schema';
export * from './campaign.create.schema';
export * from './campaign.update.schema';

// Campaign education schema
export * from './candidate_education.bulk.schema';
export * from './candidate_education.create.schema';
export * from './candidate_education.update.schema';

// Campaign Interview Processe schema
